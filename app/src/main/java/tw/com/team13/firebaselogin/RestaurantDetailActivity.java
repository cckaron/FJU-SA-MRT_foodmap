...
import tw.com.team13.Adapter.RatingAdapter;
...
public class RestaurantDetailActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBooking = findViewById(R.id.enter_booking);

        btnBooking.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(RestaurantDetailActivity.this, BookingActivity.class);
    ...
    private void onRestaurantLoaded(Restaurant restaurant) {
        ...
        mResdetail.setText(restaurant.getDescription());
        mPriceView.setText("平均價位"+restaurant.getPrice());
        Log.d(TAG, "onRestaurantLoaded: detail" + restaurant.getDescription());
